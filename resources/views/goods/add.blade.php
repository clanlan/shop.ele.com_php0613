...
<div class="modal-body">
    <form action="{{route('goods.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="form-group">
            <label class="col-sm-2 control-label">商品名称：</label>
            <div class="col-sm-8"><input type="text" name="goods_name" class="form-control" value="{{old('goods_name')}}"/></div>
            ...
            <div class="col-sm-8">
                <select name="category_id" class="form-control">
                    ...
                    @foreach($cates as $cate)
                        <option value="{{$cate->id}}" @if(old('category_id') == $cate->id) selected @endif>{{$cate->name}}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="text" name="goods_price" class="form-control" id="exampleInputAmount" value="{{old('goods_price')}}" placeholder="金额">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8"><input type="text" name="tips" class="form-control" value="{{old('tips')}}"/></div>
        </div>
